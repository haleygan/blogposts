    ...
    <header className="sticky top-0 z-40 w-full border-b border-stone-200 bg-white/90 backdrop-blur-md transition-colors">
      <div className="mx-auto flex h-[4.75rem] max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <button onClick={onPostsClick} className="group flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-emerald-600 text-white shadow-md shadow-emerald-600/15 transition-transform group-hover:rotate-6">
          ...
          <div className="flex flex-col items-start">
            ...
            <span className="mt-1 font-mono text-[10px] font-semibold uppercase tracking-wider text-emerald-600">
              loading in progress...
            </span>
          </div>
        </button>
        ...
        <nav className="flex items-center gap-1 sm:gap-2">
          <button
            ...
            className="flex items-center gap-1.5 rounded-xl bg-stone-100 px-4 py-2 text-[0.95rem] font-medium text-stone-900 transition-all hover:bg-stone-200"
          >
            <BookOpen size={15} />
            Posts
          </button>
